...
import BatchOperationBar from '../desktop/BatchOperationBar';
import ContactServiceModal from '../common/ContactServiceModal';
...
import {
  ...
  isProductExists,
} from '../../utils/helpers/productStorage';
